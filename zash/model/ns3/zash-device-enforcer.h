...
#ifndef ZASH_PACKET_SENDER_H
#define ZASH_PACKET_SENDER_H
 ...
 * \defgroup onoff ZashDeviceEnforcer
 *
 ...
 */
class ZashDeviceEnforcer : public Application
{
public:
  /**
  ...
  TracedCallback<Address, Address, string> m_traces; //!< Traced Callback: messages
